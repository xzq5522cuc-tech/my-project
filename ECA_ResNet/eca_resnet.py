...
class ResNet(nn.Module):
    """修改后的ResNet，只在全局平均池化后应用ECA"""

    def __init__(self, block, layers, num_classes=1000, k_size=3,dropout_rate=0.7):
        self.inplanes = 64
        ...
        # ECA模块：只在全局平均池化后应用
        self.eca = eca_layer(512 * block.expansion, k_size)
...
def eca_resnet18(k_size=3, num_classes=1_000, pretrained=False):
...
def eca_resnet34(k_size=3, num_classes=1_000, pretrained=False):
